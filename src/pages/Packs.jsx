...
export default function Packs() {
    ...
    return (
        <div className="min-h-screen bg-[#FAFAF8]">
            {/* ── Header ── */}
            <header
                className="text-center container mx-auto px-4 md:px-10"
                style={{ paddingTop: 'calc(var(--navbar-height) + 36px)', paddingBottom: '36px' }}
            >
                <motion.div
            ...
            {/* ── Cards ── */}
            <main className="container mx-auto px-4 md:px-10" style={{ paddingBottom: '80px' }}>
                {loading ? (
