    ...
    const fetchDashboardData = async () => {
        ...
        try {
            ...
            try {
                ...
                const currentCount = visitorData?.value?.count || 0;

                // Check if this session already counted
                const sessionKey = 'mdc_visited';
                if (!sessionStorage.getItem(sessionKey)) {
                    ...
                    visitorsCount = currentCount + 1;
                } else {
                    visitorsCount = currentCount;
                }
            } catch {
                visitorsCount = 0;
            }
            ...
            const { data: recent } = await supabase
                .from('orders')
                .select('id, order_number, customer_name, total_price, status')
