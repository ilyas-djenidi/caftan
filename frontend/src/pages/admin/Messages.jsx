...
import { getMessages as fetchMsgs, markAsRead as apiMarkRead, deleteMessage as apiDeleteMsg } from '../../api/messages.api';
...
export default function Messages() {
    ...
    const fetchMessages = async () => {
        setLoading(true);
        try {
            const result = await fetchMsgs({ limit: 200 });
