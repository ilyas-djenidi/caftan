...
import { getAdminReviews, updateReviewStatus, deleteReview } from '../../api/reviews.api';
...
export default function AdminReviews() {
    ...
    const fetchReviews = async () => {
        try {
            const result = await getAdminReviews({ limit: 200 });
            setReviews(result.data?.map(r => ({ ...r, products: { name_fr: r.product_name } })) || []);
        } catch (error) {
