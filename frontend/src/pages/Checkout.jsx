                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            {step === 1 ? (
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input required name="fullName" value={formData.fullName} onChange={handleInput} placeholder="Ex: Amina Benali" style={{ width: '100%', height: '60px', padding: '0 20px', borderRadius: '16px', border: '1px solid #f0ede8', outline: 'none', fontSize: '14px' }} className="focus:border-[#C3AB7E]" />
                                        </div>
                                        <div className="space-y-2">
                                            <label style={{ fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#111111' }}>Téléphone</label>
                                            <input required name="phone" value={formData.phone} onChange={handleInput} placeholder="05XX XX XX XX" style={{ width: '100%', height: '60px', padding: '0 20px', borderRadius: '16px', border: '1px solid #f0ede8', outline: 'none', fontSize: '14px' }} className="focus:border-[#C3AB7E]" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <select required name="wilaya" value={formData.wilaya} onChange={handleInput} style={{ width: '100%', height: '60px', padding: '0 20px', borderRadius: '16px', border: '1px solid #f0ede8', outline: 'none', fontSize: '14px' }} className="focus:border-[#C3AB7E] bg-white">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <select required name="city" value={formData.city} onChange={handleInput} disabled={!formData.wilaya} style={{ width: '100%', height: '60px', padding: '0 20px', borderRadius: '16px', border: '1px solid #f0ede8', outline: 'none', fontSize: '14px', opacity: !formData.wilaya ? 0.5 : 1 }} className="focus:border-[#C3AB7E] bg-white">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea required name="address" value={formData.address} onChange={handleInput} placeholder="Rue, quartier, n° de porte..." rows="3" style={{ width: '100%', padding: '20px', borderRadius: '16px', border: '1px solid #f0ede8', outline: 'none', fontSize: '14px', resize: 'none' }} className="focus:border-[#C3AB7E]" />
                                    </div>

                                    <button type="submit" style={{ width: '100%', height: '72px', backgroundColor: '#111111', color: 'white', borderRadius: '24px', fontWeight: '800', fontSize: '14px', letterSpacing: '0.2em', textTransform: 'uppercase', marginTop: '20px' }} className="hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3">
                                ...
                                <div className="space-y-8 animate-in fade-in slide-in-from-right duration-500">
                                    ...
                                    <button disabled={loading} type="submit" style={{ width: '100%', height: '72px', backgroundColor: '#111111', color: 'white', borderRadius: '24px', fontWeight: '800', fontSize: '14px', letterSpacing: '0.2em', textTransform: 'uppercase' }} className="hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3">
                                ...
                                {items.map((item) => (
                                    <div key={item.key} style={{ display: 'flex', gap: '16px' }}>
                                        <div style={{ width: '80px', height: '80px', borderRadius: '12px', overflow: 'hidden', backgroundColor: '#f9f9f9', flexShrink: 0 }}>
                                            <img src="/placeholder.jpg" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        </div>
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <p style={{ fontSize: '14px', fontWeight: '800', marginTop: '4px' }}>{(item.product.price * item.quantity).toLocaleString()} DA</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
